...
CREATE TABLE `friends` (
  ...
  CONSTRAINT `friendID` FOREIGN KEY (`friendID`) REFERENCES `users` (`userID`) ON DELETE CASCADE,
...
INSERT INTO `friends` VALUES ('Dummy8','amirfazel45'),('amirfazel45','Dummy8'),('Dummy9','Dummy8'),('Dummy8','Dummy9');
